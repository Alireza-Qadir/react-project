...
import 'hover.css';
     ...
     <Router>
       <div className="lg:hidden md:flex sm:flex flex justify-between "> 
         ...
         <nav className={`w-full h-auto flex lg:flex-row  md:flex-col sm:flex-col flex-col md:flex-col justify-evenly  items-center ${ isOpen ? "animate__animated animate__lightSpeedInLeft " : null }`} id="navbar">
